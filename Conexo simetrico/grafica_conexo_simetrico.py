...
plt.style.use('fast')
data = np.loadtxt('grafo_conexo_simetrico.txt')
...
plt.plot(t,media,linestyle='dashed',linewidth=2,color=(0.784, 0.22, 0.322), label=r'$\overline{X}$', markersize=2)
